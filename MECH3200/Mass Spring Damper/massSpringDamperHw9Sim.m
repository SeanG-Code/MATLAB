...
% observer    = massSpringDamperObserverNumDif(Param, measurments);
observer    = massSpringDamperObserverDirtyDif(Param, measurments);
controller  = massSpringDamperControllerPID(Param);
...
while t < Param.t_end
    ...
    while t <= t_next_plot
        ...
        % Inputs
        F = controller.update(states_hat, z_ref);
    ...
    plotter.update(t, states, estimate, references, model, inputs)
