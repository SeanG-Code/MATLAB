...
observer    = blockBeamObserverEKF(Param, measurments);
controller  = blockBeamControllerNDI(Param, measurments); % TODO
...
while t < Param.t_end
    ...
    while t <= t_next_plot
        ...
        % Inputs
        [F, states_m, theta_r] = controller.update(states_hat, z_r);
