classdef uavObserverMIMOLuenberger < handle
    properties
    ...
    methods
        function self = uavObserverMIMOLuenberger(Param, measurments)
            ...
            self.calculate_gains(Param.t_r_o_theta, Param.zeta_o_theta, ...
                Param.t_r_o_z, Param.zeta_o_z, Param.t_r_o_h, Param.zeta_o_h, Param.A, Param.C_m)
        ...
        function x_hat_dot = luenberger_dif_eq(self, states_hat, inputs, measurements)
            % HW12 SECTION START -----------------------------------------
            % Enter the differential equation describing the MIMO luenberge
        ...
        function calculate_gains(self, t_r_o_theta, zeta_o_theta, t_r_o_z, zeta_o_z, t_r_o_h, zeta_o_h, A, C_m)
