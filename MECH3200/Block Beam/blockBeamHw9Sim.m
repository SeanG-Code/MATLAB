...
% observer    = blockBeamObserverNumDif(Param, measurments);
observer    = blockBeamObserverDirtyDif(Param, measurments);
controller  = blockBeamControllerPID(Param);
...
while t < Param.t_end
    ...
    while t <= t_next_plot
        ...
        % Inputs
        [F, theta_r] = controller.update(states_hat, z_r);
