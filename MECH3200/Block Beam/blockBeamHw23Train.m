...
while episode_counter <= Param.training_episodes
    ...
    if episode_reset
        ...
        reward_history(episode_counter) = outerLoopController.total_reward;
        ...
        % Reset controller
        innerLoopController.x_m_theta = [Param.theta_0; Param.theta_dot_0];
        outerLoopController.episode_reset();

        % Return to start location
        dynamics.states = [Param.z_0;Param.theta_0;Param.z_dot_0;Param.theta_dot_0];
...
% Save Q table
outerLoopController.save_Q(Param.file_name, Param);