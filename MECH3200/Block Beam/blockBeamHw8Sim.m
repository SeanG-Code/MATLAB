...
% Instantiate objects
dynamics   = Gillam_blockBeamDynamics(Param);
controller = Gillam_blockBeamControllerPD(Param);
...
while t < Param.t_end
    ...
    while t <= t_next_plot
        ...
        % Inputs
        [F,theta_ref] = controller.update(states, z_ref);
    ...
    references    = [z_ref;theta_ref; NaN(2,1)];
